...
var Pincode = function (_a) {
    ...
    return (_jsxs("div", __assign({ className: "parent", style: style }, { children: [!styleBottomLayout && (_jsxs("div", __assign({ className: "container bottom fadeIn", style: {
