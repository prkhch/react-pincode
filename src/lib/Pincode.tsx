...
import { KEYPAD, PINCODE_PROPS } from "./types/PincodeType";
...
const Pincode = ({
  ...
  function shuffle(array: { value: string }[]) {
  ...
  const handleRandomKeypad = () => {
    shuffle(randomArray);
    const newKeypadMap: KEYPAD = { ...keypadMap };
    keysArray.forEach((key, index) => {
      newKeypadMap[key as keyof KEYPAD].value = randomArray[index].value;
    });
